...
#define AUX3_PIN                OFF               // [input only 34] Home SW for Axis1 (X_MIN)
#define AUX4_PIN                OFF               // [input only 35] Home SW for Axis2 (Y_MIN)
...
// ST4 interface
#define ST4_RA_W_PIN            23              // MISO : ST4 RA- West
#define ST4_DEC_S_PIN           19              // SCK : ST4 DE- South
#define ST4_DEC_N_PIN           18              // MOSI : ST4 DE+ North
#define ST4_RA_E_PIN            5               // SS : ST4 RA+ East
